# Ensayo 120 - Optimización de un modelo QSAR utilizando Random Forest y selección de características
# ANDAMIOS DE MURCKO Y ECFP
# Random Forest con selección de características Boruta y Mutual Information
# Categoria Bajo - Bajo - Potencia Alta
...
output_dir = "ensayo120"  # Define el nombre del directorio para guardar resultados
os.makedirs(output_dir, exist_ok=True)  # Crea el directorio "ensayo120", no genera error si ya existe
...
# Función para contar enlaces dobles no aromáticos
...
df = pd.read_csv('Antioxidant13.csv')  # Carga archivo CSV con datos moleculares

categoria_deseada = 'Bajo'  # Define categoría deseada
subcategoria_deseada = 'Bajo - Potencia Alta'  # Define subcategoría deseada
df_categoria = df[df['Category'] == categoria_deseada].copy()  # Filtra datos por categoría
df_subcategoria = df_categoria[df_categoria['subcategoria_nombre'] == subcategoria_deseada].copy()  # Filtra datos por subcategoría
