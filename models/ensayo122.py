# Ensayo 122 - Optimización de un modelo QSAR utilizando Random Forest y selección de características
# ANDAMIOS DE MURCKO Y ECFP
# Random Forest con selección de características Boruta y Mutual Information
# Categoría Bajo log(10) - Potencia Baja
...
output_dir = "ensayo122"
# Crea el directorio "ensayo122", no genera error si ya existe
...
subcategoria_deseada = 'Bajo - Potencia Baja'
