# Ensayo 119 - Optimización de un modelo QSAR utilizando Random Forest y selección de características
# ANDAMIOS DE MURCKO Y ECFP
# Random Forest con selección de características Boruta y Mutual Information
# Categoria Medio - valores bajos - potencia
...
output_dir = "ensayo119"  # Define el nombre del directorio para guardar resultados
os.makedirs(output_dir, exist_ok=True)  # Crea el directorio "ensayo118", no genera error si ya existe
...
subcategoria_deseada = 'valores bajos - potencia'  # Define subcategoría deseada
