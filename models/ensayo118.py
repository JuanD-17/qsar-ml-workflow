# Ensayo 118 - Optimización de un modelo QSAR utilizando Random Forest y selección de características
# ANDAMIOS DE MURCKO Y ECFP
# Random Forest con selección de características Boruta y Mutual Information
# Categoria Medio - rango inferior medio - potencia
...
output_dir = "ensayo118"  # Define el nombre del directorio para guardar resultados
...
def process_and_train_rf_model(X, y, output_dir, model_name):  # Define función para procesar y entrenar modelo Random Forest
    ...
    comparison = pd.DataFrame({  # Crea DataFrame para resultados
        ...
        'RMSE Validation': [results['test_r2_rf']],  # RMSE de prueba
...
subcategoria_deseada = 'rango inferior medio - potencia'  # Define subcategoría deseada
