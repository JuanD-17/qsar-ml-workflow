...
MODEL_MAPPING = {
    ...
    "Bajo_1": ("ensayo322", "terpenos_predictions1.csv", "Bajo"),
    "Bajo_2": ("ensayo323", "terpenos_predictions2.csv", "Bajo"),
    "Bajo_3": ("ensayo324", "terpenos_predictions3.csv", "Bajo"),
    # Modelos de Categoría MEDIO
    "Medio_1": ("ensayo325", "terpenos_predictions4.csv", "Medio"),
    "Medio_2": ("ensayo326", "terpenos_predictions5.csv", "Medio"),
    "Medio_3": ("ensayo327", "terpenos_predictions6.csv", "Medio"),
    "Medio_4": ("ensayo328", "terpenos_predictions7.csv", "Medio"),
    # Modelos de Categoría ALTO (integrados ensayo255)
    "Alto_1": ("ensayo329", "terpenos_predictions8.csv", "Alto"),
}
...
try:
    df_base = pd.read_csv('Terpenos.csv', sep=';')
    df_base = df_base.drop_duplicates(subset=['Smiles']).reset_index(drop=True)
    df_base.columns = df_base.columns.str.strip()
except Exception as e:
    logging.error(f"Error al cargar Terpenos.csv: {e}")
    exit()
