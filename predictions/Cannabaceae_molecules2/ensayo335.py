...
MODEL_MAPPING = {
    ...
    "Bajo_1": ("ensayo199", "cannabaceae_predictions1.csv", "Bajo"),
    "Bajo_2": ("ensayo200", "cannabaceae_predictions2.csv", "Bajo"),
    "Bajo_3": ("ensayo201", "cannabaceae_predictions3.csv", "Bajo"),
    # Modelos de Categoría MEDIO
    "Medio_1": ("ensayo202", "cannabaceae_predictions4.csv", "Medio"),
    "Medio_2": ("ensayo203", "cannabaceae_predictions5.csv", "Medio"),
    "Medio_3": ("ensayo204", "cannabaceae_predictions6.csv", "Medio"),
    "Medio_4": ("ensayo205", "cannabaceae_predictions7.csv", "Medio"),
    # Modelos de Categoría ALTO (integrados ensayo184)
    "Alto_1": ("ensayo206", "cannabaceae_predictions8.csv", "Alto"),
}
...
try:
    df_base = pd.read_csv('Cannabaceae_molecules2.csv', sep=';')
    df_base = df_base.drop_duplicates(subset=['Smiles']).reset_index(drop=True)
    df_base.columns = df_base.columns.str.strip()
except Exception as e:
    logging.error(f"Error al cargar Cannabaceae_molecules2.csv: {e}")
    exit()
