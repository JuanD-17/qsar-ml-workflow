...
results_df.to_csv(os.path.join(output_dir, 'cannabaceae_predictions.csv'), sep=';', index=False, float_format='%.6f')
logging.info(f"Predictions saved to {os.path.join(output_dir, 'cannabaceae_predictions.csv')}")
